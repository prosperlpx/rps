...
export default function Game({
  ...
  function handleScore(e) {
    ...
    setYourPick(e.target.alt || e.target.id); //gets your pick
    const gameObj = {
      rock: "rock",
      paper: "paper",
      scissors: "scissors",
